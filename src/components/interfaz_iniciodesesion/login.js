...
import '../styles.css'; // Importa el archivo de estilos desde la carpeta superior
  ...
  return (
    <div className="login-box">
      ...
      <form>
        ...
        <button type="button" onClick={handleSignUpClick}>Registrarse</button> {/* Botón que redirige a la página de registro */}
      </form>
    </div>
  );
};
